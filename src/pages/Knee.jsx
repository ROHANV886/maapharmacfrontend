...
const Knee = () => {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("knee") // Your original logic
    )
    .filter((item) => {
      // 1. Search Filter
      const matchSearch =
      ...
      return matchSearch && !isNaN(numericPrice) && numericPrice <= maxPrice && matchCategory;
    });
    ...
    <>
      <div className="abdominal-page">
        ...
        <div className="banner">
          <img
            src="https://www.tynorstore.com/media/catalog/category/shop_for_knee-a49a2439.webp"
            alt="Knee Banner"
