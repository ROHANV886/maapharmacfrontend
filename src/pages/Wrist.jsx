...
// ✅ Removed flamingoData import as it wasn't in your original code
//    (If you need it, add it back like in Shoulder.jsx)
...
const Wrist = () => {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("wrist") // Your original logic
    )
    .filter((item) => {
      // 1. Search Filter
      const matchSearch =
