...
export default function Ankle() {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("ankle") // Kept this specific filter
    )
    .filter((item) => {
      // 1. Search Filter
      const matchSearch =
  ...
  return (
    <div className="abdominal-page">
      {/* ✅ Updated Popup (bottom-right style) */}
      {showPopup && (
        <div
      ...
      <div className="banner">
        <img
          src="https://www.tynorstore.com/media/catalog/category/shop_for_foot_1-2e5c310d.webp"
          alt="Ankle Banner"
