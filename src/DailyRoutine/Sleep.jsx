...
export default function Sleep() {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("sleep") // keep specific filter if needed
    )
    .filter((item) => {
      const matchSearch =
        item.name &&
  ...
  return (
    <div className="abdominal-page">
      ...
      <div className="banner">
        <img
          src="https://www.tynorstore.com/media/catalog/category/Sleeping_support-bebef58a.webp"
          alt="Banner"
