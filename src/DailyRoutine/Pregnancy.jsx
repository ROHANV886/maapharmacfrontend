...
export default function Pregnancy() {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("pregnancy") // keep specific filter if needed
    )
    .filter((item) => {
      const matchSearch =
        item.name &&
  ...
  return (
    <div className="abdominal-page">
      ...
      <div className="banner">
        <img
          src="https://www.tynorstore.com/media/catalog/category/Pregnancy_support-d94313a8.webp"
          alt="Banner"
