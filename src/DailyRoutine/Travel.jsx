...
export default function Travel() {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("travel") // keep specific filter if needed
    )
    .filter((item) => {
      const matchSearch =
        item.name &&
  ...
  return (
    <div className="abdominal-page">
      ...
      <div className="banner">
        <img
          src="https://www.tynorstore.com/media/catalog/category/Kids_support-546b4eb1.webp"
          alt="Banner"
