...
export default function Posture() {
  ...
  const filteredProducts = allProducts
    .filter(
      (item) =>
        item.subCategory &&
        item.subCategory.toLowerCase().includes("posture") // keep specific filter if needed
    )
    .filter((item) => {
      const matchSearch =
        item.name &&
  ...
  return (
    <div className="abdominal-page">
      ...
      <div className="banner">
        <img
          src="https://www.tynorstore.com/media/catalog/category/Posture_support-d4744fbc.webp"
          alt="Banner"
